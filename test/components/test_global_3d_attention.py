...
from snraware.components.model.attention import Global3DAttention
from snraware.components.setup import end_timer, get_device, set_seed, start_timer


# -----------------------------------------------------------------
@pytest.mark.gpu
class TestGlobal3DAttention:
    def setup_class(self):
        ...
        self.data_root = str(Current_DIR) + "/../data/global_3d"
